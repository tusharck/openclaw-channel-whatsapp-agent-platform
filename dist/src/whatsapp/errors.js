...
export function describeError(kind, fallback) {
    switch (kind) {
        case "auth":
...
export function isIndeterminate(kind) {
 ...
 */
export function errorFromResponse(status, body, secret) {
    const envelope = (body ?? {});
...
export function networkError(cause, secret) {
